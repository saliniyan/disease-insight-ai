...
# Assume 'all_symptoms' contains all the possible symptoms that were in the training data
all_symptoms = df1.columns.tolist()  # Column names are symptoms in this case

# Encode symptoms (labels)
for col in df1.columns:
    df1[col] = le.fit_transform(df1[col])  # Ensure this matches the model training
